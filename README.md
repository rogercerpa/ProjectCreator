...
<!-- AUTO:BADGES:START -->
[![Version](https://img.shields.io/badge/version-5.0.248-blue.svg)](package.json)
...
- `npm run version:patch` - Increment patch version (5.0.248 → 5.0.249)
- `npm run version:minor` - Increment minor version (5.0.248 → 5.1.0)
- `npm run version:major` - Increment major version (5.0.248 → 6.0.0)
