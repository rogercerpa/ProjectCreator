...
<!-- AUTO:BADGES:START -->
[![Version](https://img.shields.io/badge/version-5.0.243-blue.svg)](package.json)
...
- `npm run version:patch` - Increment patch version (5.0.243 → 5.0.244)
- `npm run version:minor` - Increment minor version (5.0.243 → 5.1.0)
- `npm run version:major` - Increment major version (5.0.243 → 6.0.0)
